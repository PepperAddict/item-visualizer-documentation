...
<br />
    ...
    <p>
        <strong>Open Source</strong>: If you came here to check out the open source for Item Visualizer, it is located here:
        <a href="https://github.com/PepperAddict/Item-Visualizer">Item Visualizer's Github Page</a>. 
    </p>
